      ...
      >
        ...
        <div className="p-8 grid grid-cols-2 gap-8 border-b border-gray-100 bg-white">
          ...
          <div className="text-right">
            ...
            <p className="text-sm font-mono font-bold text-gray-900 uppercase">
              #TRX-{investment.id}
            </p>
          </div>
        </div>
              ...
              >
                ...
                <div className="flex justify-between items-center text-[10px] font-bold uppercase tracking-tight">
                  <span className="text-gray-400">
                    {comm.member?.position.title} • {comm.type}
                  </span>
                  <span className="text-emerald-600 bg-emerald-50 px-1.5 py-0.5">
                    {((comm.amount / investment.amount) * 100).toFixed(2)}%
                    SHARE
                  </span>
                </div>
              </div>
          ...
          <div className="flex justify-between items-end">
            <div className="space-y-4">
              ...
              <p className="text-[9px] font-medium text-gray-400 max-w-50 leading-relaxed">
                This document serves as formal confirmation of funds processed
                via the internal ledger.
              </p>
            </div>
            <div className="text-right">
