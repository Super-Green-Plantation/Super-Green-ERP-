...
// නිවැරදි පේළිය:
import { createMember } from "@/app/features/branches/employees/[id]/actions";
        ...
        <form action={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-gray-100 bg-gray-50 py-3 pl-12 pr-4 text-sm font-semibold outline-none focus:border-blue-400 focus:bg-white transition-all shadow-sm"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              {/* Select Element */}
              <select className="w-full bg-white border border-gray-200 text-gray-700 text-sm rounded-xl px-11 py-3 outline-none appearance-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all cursor-pointer">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                required
                placeholder="077..."
                className="w-full rounded-2xl border border-gray-100 bg-gray-50 py-3 px-4 text-sm font-semibold outline-none focus:border-blue-400 focus:bg-white transition-all shadow-sm"
              />
            </div>
            <div className="space-y-1.5">
              <label className="text-[10px] font-black uppercase tracking-wider text-gray-400 ml-1">
