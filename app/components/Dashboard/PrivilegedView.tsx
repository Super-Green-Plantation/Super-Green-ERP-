    ...
    <div className="mx-auto flex min-h-screen w-full max-w-[1480px] flex-col gap-6 px-4 pb-10 pt-5 sm:px-7 sm:pt-8">
      ...
      <section className="animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <FloatingKpiCard icon={<BarChart2 className="h-4 w-4" />} title="Total achievement" value={`${percentage}%`} subValue="Against Rs. 500M company target" trend={percentage >= 50 ? "up" : "neutral"} trendValue={`Rs. ${(achievement / 1000000).toFixed(1)}M / ${(target / 1000000).toFixed(1)}M`} />
        </div>
      </section>
