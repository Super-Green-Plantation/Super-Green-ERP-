...
const Error = () => {
  return (
    <div className="flex flex-col items-center justify-center py-16 bg-rose-50/30 rounded-3xl border border-rose-100/50 border-dashed">
      ...
      <h3 className="text-sm font-bold text-rose-900 uppercase tracking-widest">
      ...
      <button
        ...
        className="mt-6 px-6 py-2 bg-white text-rose-600 border border-rose-200 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-rose-600 hover:text-white hover:border-rose-600 transition-all shadow-sm active:scale-95"
      >
        Retry
      </button>
    </div>
