        ...
        >
          <div>
            ...
            <input
              ...
              placeholder="e.g. Life Secure Pro"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              name="description"
              required
              className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none h-28 resize-none"
