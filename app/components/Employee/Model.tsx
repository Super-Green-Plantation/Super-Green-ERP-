...
useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let finalEmpNo = formData.empNo.trim();
      if (!finalEmpNo) {
        if (mode === "add") {
          finalEmpNo = await getAutoGeneratedEmpNo();
        } else {
          finalEmpNo = initialData?.empNo ?? await getAutoGeneratedEmpNo();
        }
      }
      ...
      if (profilePicFile) {
        ...
        const uploadRes = await uploadProfilePic(profilePicFile, finalEmpNo);
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      placeholder="Auto-generated if empty (e.g. EMP001)"
